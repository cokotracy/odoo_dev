...
class HrAppraisalPlan(models.Model):
    ...
    duration = fields.Integer(string="Create a New Appraisal", default=6, required=False) #Changed Required
    event = fields.Selection([
        ('arrival', 'month after the arrival date'),
        ('last_appraisal', 'month after the last appraisal')
        ], string='After', required=False, default='last_appraisal') #Changed Required
