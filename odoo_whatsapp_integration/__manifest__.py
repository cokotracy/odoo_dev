{
    ...
    'summary': """
        ...
        -Creados wizards para conexión y envío de mensajes
        -Cambiados archivos de modelos
        -Corrección de link de whatsapp web y versión de módulo. 
        """,

    'description': """
    """,
    'author': "Techspawn Solutions Pvt. Ltd. & Giovanny Vizcaya",
    ...
    'data': [
        ...
        'wizard/message_wizard.xml', #Añadido
        'wizard/wizard.xml', #Añadido
        'wizard/wizard_contact.xml', #Añadido
        'wizard/share_action.xml', #Añadido
    ],
